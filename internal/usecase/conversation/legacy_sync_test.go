...
func TestSyncLegacyBuildsOldConversationFromDirectoryAndRecentMessages(t *testing.T) {
	...
	app := New(Options{Directory: directory, Hydrator: hydrator, LegacyMessages: messages, MembershipAuthority: allowConversationMembershipAuthority()})
...
func TestSyncLegacyRetriesUnresolvedWithoutSilentlyDroppingConversation(t *testing.T) {
	...
	app := New(Options{
		...
		LegacyMessages: &echoLegacyMessageReader{}, MembershipAuthority: allowConversationMembershipAuthority(),
	})
...
func TestSyncLegacyBoundsRecentMessageBatches(t *testing.T) {
	...
	app := New(Options{Directory: directory, Hydrator: dynamicLegacyHydrator{}, LegacyMessages: messages, MembershipAuthority: allowConversationMembershipAuthority()})
