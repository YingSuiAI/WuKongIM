...
| [docs-site/FLOW.md](../../docs-site/FLOW.md) | `subtree` | Builds the bilingual public documentation site from navigation, MDX content, source-backed contracts, and publication evidence. | 50 | ok |
| [internal/access/api/FLOW.md](../../internal/access/api/FLOW.md) | `package` | Adapts product HTTP requests to injected use cases and exposes configured health, diagnostics, benchmark, and Demo surfaces. | 60 | ok |
...
| [internal/access/manager/FLOW.md](../../internal/access/manager/FLOW.md) | `package` | Adapts authenticated Manager HTTP and UI operations to bounded management use cases. | 87 | ok |
| [internal/access/node/FLOW.md](../../internal/access/node/FLOW.md) | `package` | Adapts versioned node RPC frames to local authority, runtime, and management ports. | 95 | ok |
...
| [internal/app/FLOW.md](../../internal/app/FLOW.md) | `package` | Composes configured cluster and node runtimes, use cases, adapters, workers, observability, and their coordinated lifecycle. | 57 | ok |
| [internal/bench/FLOW.md](../../internal/bench/FLOW.md) | `subtree` | Loads benchmark scenarios, plans deterministic worker assignments, drives bounded workloads, and produces evidence-based reports. | 55 | ok |
...
| [internal/contracts/channelappend/FLOW.md](../../internal/contracts/channelappend/FLOW.md) | `package` | Defines immutable entry-independent Channel append, authority, result, and committed-envelope contracts with stable error families. | 55 | ok |
| [internal/contracts/channelmembers/FLOW.md](../../internal/contracts/channelmembers/FLOW.md) | `package` | Defines stable derived member-list identities and the narrow live-membership authority contract shared by use cases. | 46 | ok |
...
| [internal/infra/backup/FLOW.md](../../internal/infra/backup/FLOW.md) | `package` | Adapts backup repositories, cluster routing, Controller state, export, and restore ports without owning backup policy. | 58 | ok |
...
| [internal/infra/cluster/FLOW.md](../../internal/infra/cluster/FLOW.md) | `package` | Adapts internal ports to routed cluster and Channel capabilities while preserving authority, immutable identities, and typed results. | 59 | ok |
...
| [internal/runtime/channelappend/FLOW.md](../../internal/runtime/channelappend/FLOW.md) | `package` | Owns routed local Channel append admission, ordered durable writes, item futures, and bounded post-commit delivery handoff. | 96 | ok |
...
| [internal/runtime/delivery/FLOW.md](../../internal/runtime/delivery/FLOW.md) | `package` | Executes canonical online delivery plans with bounded Channel ordering, owner routing, retries, and RECVACK state. | 68 | ok |
...
| [internal/runtime/webhook/FLOW.md](../../internal/runtime/webhook/FLOW.md) | `package` | Performs bounded node-local best-effort delivery of message, offline-recipient, and online-status webhooks. | 54 | ok |
...
| [internal/usecase/channel/FLOW.md](../../internal/usecase/channel/FLOW.md) | `package` | Orchestrates channel metadata, ordinary membership, derived member lists, versioning, projection, and bounded iteration. | 92 | ok |
...
| [internal/usecase/conversation/FLOW.md](../../internal/usecase/conversation/FLOW.md) | `package` | Builds bounded UID-owned conversation pages and coordinates current membership, head hydration, badge floors, hide, and activation. | 51 | ok |
...
| [internal/usecase/management/FLOW.md](../../internal/usecase/management/FLOW.md) | `package` | Builds entry-independent Manager read models and safety-gated orchestration over narrow cluster, runtime, and diagnostic ports. | 87 | ok |
| [internal/usecase/message/FLOW.md](../../internal/usecase/message/FLOW.md) | `package` | Orchestrates entry-independent message permission, append submission, ordinary history synchronization, and message-event projection. | 60 | ok |
...
| [internal/usecase/user/FLOW.md](../../internal/usecase/user/FLOW.md) | `package` | Orchestrates legacy-compatible user tokens, device quit, online status, system UIDs, and restore cache reload. | 54 | ok |
...
| [pkg/client/FLOW.md](../../pkg/client/FLOW.md) | `package` | Provides a tooling-grade WKProto TCP client with session crypto, bounded SEND/RECV queues, exact ACK matching, and pooling. | 67 | ok |
| [pkg/cluster/FLOW.md](../../pkg/cluster/FLOW.md) | `subtree` | Composes the cluster Node facade, authoritative routing, Slot proposals, Channel services, maintenance, and cluster lifecycle. | 57 | ok |
...
| [pkg/slot/FLOW.md](../../pkg/slot/FLOW.md) | `subtree` | Runs Slot Raft groups, deterministically applies hash-slot metadata commands, and exposes routed metadata proxy operations. | 54 | ok |
