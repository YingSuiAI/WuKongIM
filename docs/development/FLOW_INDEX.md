...
| [internal/access/api/FLOW.md](../../internal/access/api/FLOW.md) | `package` | Adapts product HTTP requests to injected use cases and exposes configured health, diagnostics, benchmark, and Demo surfaces. | 54 | ok |
...
| [internal/app/FLOW.md](../../internal/app/FLOW.md) | `package` | Composes configured cluster and node runtimes, use cases, adapters, workers, observability, and their coordinated lifecycle. | 53 | ok |
...
| [internal/infra/cluster/FLOW.md](../../internal/infra/cluster/FLOW.md) | `package` | Adapts internal ports to routed cluster and Channel capabilities while preserving authority, immutable identities, and typed results. | 56 | ok |
...
| [internal/usecase/message/FLOW.md](../../internal/usecase/message/FLOW.md) | `package` | Orchestrates entry-independent message permission, append submission, ordinary history synchronization, and message-event projection. | 52 | ok |
